...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white p-8 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20"></div>
      <div className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="w-full md:w-1/2 flex flex-col items-center">
            ...
            <Button 
              ...
              className="w-full max-w-xs bg-yellow-600 hover:bg-yellow-700"
              variant="outline"
            >
        ...
        <div className="mt-8 flex justify-center items-center">
          <Input
            ...
            className="w-32 mr-4 bg-gray-800 text-white border-yellow-500"
          />
        </div>
      </div>
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="bg-gray-900 text-white border border-yellow-500">
          <DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleConfirmBet} className="bg-yellow-600 hover:bg-yellow-700">Confirm Bet</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
